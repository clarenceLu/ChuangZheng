...
TextField*  AddHospitalCaseScene::createBasicData(Sprite* bkView,Vec2 point,string name1,string name2){
    ...
    textFieldUser->addEventListener(CC_CALLBACK_2(AddHospitalCaseScene::eventCallBack, this));
